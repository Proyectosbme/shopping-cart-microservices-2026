 ...
 *
 * <p>Provides a consistent structure across all error codes so API consumers can handle
 * failures uniformly. The {@code timestamp} is set automatically at construction time.</p>
 */
@Getter
public class ErrorResponseDTO {
    ...
    /** Application-level error code for programmatic handling (e.g., "PAYMENT_NOT_FOUND"). */
